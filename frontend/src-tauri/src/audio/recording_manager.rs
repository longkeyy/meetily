...
use super::recording_state::{
    AudioChunk, DeviceType as RecordingDeviceType, RecordingState, SourceActivityEvent,
};
...
impl RecordingManager {
    ...
    pub async fn start_recording(
        ...
        let (source_activity_sender, source_activity_receiver) =
            mpsc::unbounded_channel::<SourceActivityEvent>();
        ...
        Ok((transcription_receiver, source_activity_receiver))
    }
